...
const contacts = [
  ...
  { icon: Linkedin, label: "LinkedIn", value: "linkedin.com/in/loago-rantao-190324257", href: "https://linkedin.com/in/loago-rantao-190324257/" },
  { icon: Github, label: "GitHub", value: "github.com/loagorantao-hash", href: "https://github.com/loagorantao-hash" },
  { icon: MessageCircle, label: "WhatsApp / Call", value: "+267 7145 8185", href: "https://wa.me/26771458185" },
];
...
const Contact = () => {
  ...
  <div className="pt-16">
    ...
    <section className="section-container py-16 md:py-24 border-b border-border">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground font-light tracking-wide mt-4">
          Open to Business Intelligence & Data Analytics roles, software development projects, and Autobots Dev corporate partnerships.
        </p>
      </motion.div>
    </section>
    ...
    <section className="section-container py-16">
      ...
      >
        <h3 className="font-heading text-xl font-light tracking-wide mb-4">Engagement Opportunities</h3>
        <ul className="space-y-3">
          {[
            "Business Intelligence & Data Analyst opportunities",
            "Software & Mobile Application Development with Autobots Dev (Pty) Ltd.",
            "Reporting Automation & Power BI dashboard consulting",
            "Data Governance, Reconciliation & ETL consulting",
            "Corporate partnerships & technology solutions in Botswana"
          ].map((item) => (
      ...
      >
        <h3 className="font-heading text-xl font-light tracking-wide mb-4">Curriculum Vitae</h3>
        <p className="text-muted-foreground text-sm font-light mb-4">
          Download my updated CV with complete details on First Class Honours qualification, FNB Botswana BI analyst experience, and software accomplishments.
        </p>
